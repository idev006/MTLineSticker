...
This is the canonical v1.2 production specification. The legacy file `SET-006-PRODUCTION-SPEC-v1.0.md` remains only for history/compatibility and must not be treated as the active version.
